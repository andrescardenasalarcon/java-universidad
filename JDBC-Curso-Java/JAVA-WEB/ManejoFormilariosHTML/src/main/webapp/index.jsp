...
<body>
<br/>
<form action="/ManejoFormilariosHTML-1.0-SNAPSHOT/servelet" name="form1" method="post" onsubmit="return validarForma(this)">
    ...
    <table width="200" id="enfasis-columna">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="default" name="usuario" value="Escribir usuario"
                       onfocus="this.select()">
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input class="defult" type="password" name="password"
                       onfocus="this.select()">
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                &nbsp;&nbsp;&nbsp;
                .Net <input type="checkbox" name="tecnologia" value="php">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <textarea name="comentarios" id="" cols="30" rows="2" class="default"
