    ...
    <form action="${urlAgregar}" modelAttribute="empleadoForma" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="departamento" name="departamento"
                   aria-describedby="departamentoHelp" required>
            <div id="departamentoHelp" class="form-text">We'll never share your email with anyone else.</div>
        </div>
        <div class="mb-3">
            <label for="sueldo" class="form-label">Sueldo</label>
            <input type="number" step="any" class="form-control" id="sueldo" name="sueldo"
                   aria-describedby="sueldoHelp" required>
            <div id="sueldoHelp" class="form-text">We'll never share your email with anyone else.</div>
        </div>
